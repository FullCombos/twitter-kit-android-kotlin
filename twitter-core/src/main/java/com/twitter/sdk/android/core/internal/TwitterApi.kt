...
class TwitterApi @JvmOverloads constructor(val baseHostUrl: String = BASE_HOST_URL) {
    ...
    companion object {
        ...
        fun buildUserAgent(clientName: String, version: String): String {
            val ua = StringBuilder(clientName)
                .append('/')
                .append(version) // NOTE: We currently do not provide client_version_code information.
                .append(' ')
                ...
                .append(Build.PRODUCT) // NOTE: We do not add client_source, preload, or wifi information.
                .append(')')
     ...
     * @return [android.net.Uri.Builder] that can be used to further build the url.
     */
